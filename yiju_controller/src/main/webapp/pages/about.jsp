...
<%--<div class="content">--%>
<div class="width1190">
    <p style="font-size: 16px">当前位置：<a href="../index.jsp">首页</a> ＞＞ <a href="../pages/about.jsp">关于我们</a></p>
</div>
...
<div class="content">
    <div class="width1190">
        <div class="contleft">
            <ul class="leftNav">
                <li class="leftNavCur"><a href="../pages/about.jsp">关于我们</a></li>
                <li><a href="../pages/contact.jsp">联系我们</a></li>
            </ul><!--leftNav/-->
        </div><!--contleft/-->
        <div class="contright">
            <h2 class="rightat">实训一组，为您提供贴心服务!</h2>
            <div class="about">
                <img src="../images/about.jpg" /><br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;从创立之初，实训一组便在修浩PM的指导下，小组成员的努力下，夜以继日，废寝忘食，完成了易居的开发。其中特别鸣谢滚动栏李先锋的无私奉献。
                <br /><br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </div>
        </div><!--contright/-->
        <div class="clears"></div>
