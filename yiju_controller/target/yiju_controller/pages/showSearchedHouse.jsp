            ...
            <tr>
                ...
                <td>
                    <div class="searchbox">
                        ...
                        <form action="/house/getAllHouseByFuzzySearch.do" method="post">
...
<%--<div class="content">--%>
<div class="width1190">
    <p style="font-size: 16px">当前位置：<a href="../index.jsp">首页</a> ＞＞ <a href="/house/searchHouseViewByType.do">搜索房源</a></p>
</div>
    ...
    <div class="width1190">
        ...
        <div class="pro-right">
            ...
            <div class="right-pro">
                ...
                %>
                <dl>
                    <dt><a href="#"><img src="../images/fang1.jpg"/></a></dt>
                    <dd>
                        <h3><a href="#">中装一室一厅，楼层好，采光足，稀缺房源</a></h3>
