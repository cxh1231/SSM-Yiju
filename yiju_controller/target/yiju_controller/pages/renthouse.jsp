            ...
            <tr>
                ...
                <td>
                    <div class="searchbox">
                        ...
                        <form action="/house/getHouseByFuzzySearch.do?house_type=2" method="post">
                            <input type="text" name="house_title" id="searchPlaceholder" class="import" placeholder="请输入租房搜索信息">
...
<%--<div class="content">--%>
<div class="width1190">
    <p style="font-size: 16px">当前位置：<a href="../index.jsp">首页</a> ＞＞ <a href="/house/searchHouseViewByType.do?house_type=2&page=1&size=6">租房</a></p>
</div>
    ...
    <div class="width1190">
        <div class="pro-left">
            ...
            <div class="pull-right">
                <ul class="pagination">
                    <li ><a href="${pageContext.request.contextPath}/house/searchHouseViewByType.do?house_type=2&page=${pageInfo.firstPage}&size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
                    <li><a href="${pageContext.request.contextPath}/house/searchHouseViewByType.do?house_type=2&page=${pageInfo.pageNum - 1}&size=${pageInfo.pageSize}">上一页</a></li>
                    <c:forEach begin="1" end ="${pageInfo.pages}" var="pageNum">
                        <li><a href="${pageContext.request.contextPath}/house/searchHouseViewByType.do?house_type=2&page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
                    </c:forEach>
                    <li><a href="${pageContext.request.contextPath}/house/searchHouseViewByType.do?house_type=2&page=${pageInfo.pageNum + 1}&size=${pageInfo.pageSize}">下一页</a></li>
                    <li><a href="${pageContext.request.contextPath}/house/searchHouseViewByType.do?house_type=2&page=${pageInfo.lastPage}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
                </ul>
            </div><!--底部分页栏-->
        </div><!--pro-left/-->
